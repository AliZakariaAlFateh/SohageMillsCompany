...
namespace Sohag__Mills_Company.Controllers
{
    public class System_UsersController : Controller
    {
        ...
        public System_UsersController(IRepository<Shareholder_Structure> _repostory, UserManager<IdentityUser> userManager)
        {
        ...
        //public async Task<IActionResult> AllUsers(int pageNumber, int pageSize = 5)
        //{
